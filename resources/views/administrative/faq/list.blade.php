						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="row">					
									...
									<div class="col-md-6">
										<div class="input-group date date-picker margin-bottom-5" data-date-format="yyyy-mm-dd">
											<input type="text" id="create_date_to" class="form-control form-filter input-sm" readonly name="order_date_from" placeholder="To">
											<span class="input-group-btn">
											<button class="btn btn-sm default" type="button"><i class="fa fa-calendar"></i></button>
											</span>
										</div>
...
<div>
	<a href="{{url('administrative/faq/view')}}" class="btn btn-primary btn-sm">+ 추가</a>
</div>
<br>
...
jQuery(document).ready(function(){
    ...
    grid.getTableWrapper().on('click', 'tr', function (e) {
		...
		if(isNaN(id) == false){
			location.href="{{url('administrative/faq/view?id=')}}" + id;
		}*/		
    });
