...
<div>
	<a href="{{url('administrative/push/view')}}" class="btn btn-primary btn-sm">+ 추가</a>
</div>
<br>
...
jQuery(document).ready(function(){
    ...
    grid.init({
        ...
        dataTable: { 
            ...
            "pageLength": 10,
            "ajax": {
                "url": "{{url('api/getPushNotificationList')}}"
            },
            "order": [
                [1, "asc"]
            ]
    ...
    grid.getTableWrapper().on('click', 'tr', function (e) {
		...
		if(isNaN(id) == false){
			location.href="{{url('administrative/push/view?id=')}}" + id;
		}*/		
    });
