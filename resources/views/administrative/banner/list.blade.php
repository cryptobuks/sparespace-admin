					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label class="control-label">배너 제목</label>
...
<div>
	<a href="{{url('administrative/banner/view')}}" class="btn btn-primary btn-sm">+ 추가</a>
</div>
<br>
...
jQuery(document).ready(function(){
    ...
    grid.getTableWrapper().on('click', 'tr', function (e) {
		...
		if(isNaN(id) == false){
			location.href="{{url('administrative/banner/view?id=')}}" + id;
		}*/		
    });
